...
class BEiT(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=16, in_chans=3, num_classes=80, embed_dim=768,
        ...
        #     if name=="cls_token" or name.startswith("blocks.0.gamma"):
        #         print("{:30s}:{}".format(name,self.state_dict()[name]))
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(pretrained, str):
            ...
            checkpoint, all_keys = load_checkpoint(self, pretrained, strict=False, logger=logger)
            return all_keys
